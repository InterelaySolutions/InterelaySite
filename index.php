<html><head>
        ...
        <link rel='icon' href='/site/icons/interelay_small.ico' type='image/x-icon'/ >
...
<br><br>
        ...
        <div class="slide" style="background-image: url('/site/images/slide3_v1.jpg'); background-repeat:no-repeat; background-size:cover; margin:0px; position: relative;top: -47px;padding-top: 10px;margin-top: 20px; padding-bottom:100px;">
            <div class="container">
