...
<br><br>
            <div id="three_way_container">
                <div class="equal-div33"><img src="images/softdev.png" style="width:100%;max-width:150px; height:auto;"><h3>Bespoke software development</h3><p>We have a proven track record to develop custom software solutions for your company.  We perform a design brief for you which outlines the features of your solution and how to integrate it into your regular workflows.  We can create a full-stack custom solution for you, using proven technologies (PHP, Python, CSS, SQL, Javascript/JQuery)</p></div>
                <div class="equal-div33"><img src="images/website-design.png" style="width:100%; max-width:150px; height:auto;"><h3>IT Services Consultancy</h3><p>Not sure how you want to get from A to B?  We can help provide consulations which will provide an informed pathway to get you to your goals.  IT project management can be tricky and overly costly, let us put you on the right track to avoid redevelopment or recreation at a later stage.</p></div><div class="equal-div33"><img src="images/Circle-icons-computer.png" style="width:100%;max-width:150px; height:auto;"><h3>Hardware and Software Challenges</h3><p>Our IT support technicians has over ten years of experience in handling software and hardware faults.  Performing ad-hoc repairs and ensure a resolution before leaving the premises.  We provide a call-out service for home users and a contracted service for regular maintenence of business infrastructure (Hardware and Software based).  Contact us now too see what managed IT solutions we can provide for you, or if you're a customer, please call now and book an appointment!</p></div><div class="equal-div33"><img src="images/network.png" style="width:100%;max-width:150px; height:auto;"><h3>Providing Networking and Administrative services</h3><p>Our technicians have considerable experience in providing Network Administrative assistance, ranging from Active Directory to Windows Server to Linux.  We can provide IT management solutions for your business, removing the need to manage your network infrastructure within the company, saving you time, money and resources.</p></div>
            </div>
        </div>
        ...
        <div class="slide" style="background-image: url('images/slide3_v1.jpg'); background-repeat:no-repeat; background-size:cover; margin:0px; position: relative;top: -47px;padding-top: 10px;margin-top: 20px; padding-bottom:100px;">
            <div class="container">
